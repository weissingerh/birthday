    ...
    <x-slot name="content">
        ...
        <div class="max-w-xl px-6 mx-auto text-white">
            <p class="mb-4 leading-relaxed">
                ...
                Sonderveranstaltung und du wurdest als Special Act ausgewählt! Die VIP Veranstaltung findet am 28. Mai
                ab 15 Uhr auf der Donauinsel beim Grillplatz 10 auf der Donauinsel statt. Bei Schlechtwetter wird in der
                Canisiusgasse 16 im Partykeller gefeiert, das wird rechtzeitig bekannt gegeben.
            </p>
            <p>
                Komm in deinem besten Festival-Outfit und nimm dir etwas Grillbares mit. Ich werde Beilagen sowie Bier
                und Wein besorgen, bring gerne auch selbst was mit!
            </p>
        </div>
        <div id="splide" class="py-10 splide ">
